...
export default function PortfolioPage() {
  const projects = [
    ...
    },
    {
      ...
      description: 'Compleet toernooimanagementsysteem voor judoverenigingen. Van deelnemersimport tot automatische poule-indeling, live wedstrijdscoring en prijsuitreiking. Werkt naadloos samen met de JudoScoreBoard Android app voor live scoreborden op de mat.',
      technologies: ['Laravel 11', 'PHP 8.2', 'MySQL', 'QR Scanner', 'WebSocket'],
      features: [
        'Automatische poule-indeling (leeftijd/gewicht/band)',
        'Weging interface met QR scanner',
        'Mat interface voor live scoring',
        'Koppeling met JudoScoreBoard app (WebSocket)',
        'CSV/Excel import',
      ],
    },
    {
      ...
      image: '/portfolio/judoscoreboard-icon.png',
